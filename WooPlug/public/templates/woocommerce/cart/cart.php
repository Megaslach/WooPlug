...
<form class="woocommerce-cart-form product-space" id="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <ul class="shop_table shop_table_responsive cart woocommerce-cart-form__contents cart-tab white-card" cellspacing="0">
        ...
        foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
            ...
            if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                ...
                ?>
                <li class="woocommerce-cart-form__cart-item product-tab <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                    ...
                    <div class="product-info">
                        ...
                        <div class="remove-and-quantity">
                            <!-- Ajoutez une div pour styliser la quantité -->
                            <div class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
                                <?php
                                // Déplace la colonne de la quantité du produit ici
                            ...
                            <!-- Fin de la div pour la quantité -->
        ...
        <li>
            <div colspan="6" class="actions hide">
