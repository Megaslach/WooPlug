...
class sandbox {
    ...
    private function define_public_hooks() {
        ...
        $this->loader->add_action( 'wp_ajax_nopriv_sandbox_update_gift_message', $plugin_product_extras, 'sandbox_update_gift_message' );
        $this->loader->add_action( 'wp_ajax_sandbox_update_gift_message', $plugin_product_extras, 'sandbox_update_gift_message' );
        // Ajax delete custom cart item meta
        $this->loader->add_action( 'wp_ajax_nopriv_sandbox_delete_gift_option', $plugin_product_extras, 'sandbox_delete_gift_option' );
        $this->loader->add_action( 'wp_ajax_sandbox_delete_gift_option', $plugin_product_extras, 'sandbox_delete_gift_option' );
        // Ajax add custom cart item meta
        $this->loader->add_action( 'wp_ajax_nopriv_sandbox_add_gift_option', $plugin_product_extras, 'sandbox_add_gift_option' );
        $this->loader->add_action( 'wp_ajax_sandbox_add_gift_option', $plugin_product_extras, 'sandbox_add_gift_option' );
    }
